...
Откройте **Библиотека → Сериалы**, выберите сериал и нажмите **Удалить сезон**
в блоке «По сезонам». Проверьте план выбранного сезона и подтвердите его
(либо выполните симуляцию в dry-run). Остальные сезоны и запись сериала
сохраняются. Прямое удаление из Jellyfin относится только к точно сопоставленному
сезону; при отсутствующей или неоднозначной связи этот шаг не включается в план.
