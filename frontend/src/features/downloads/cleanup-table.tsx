...
export function CleanupTable({ candidates, language, text, selected, onToggle, onInspect, onDelete, canMutate = true, mutationUnavailableReason }: { candidates: CleanupCandidate[]; language: DownloadsLanguage; text: DownloadsCopy; selected: BatchSelection; onToggle: (candidate: CleanupCandidate) => void; onInspect: (candidate: CleanupCandidate, trigger: HTMLElement) => void; onDelete: (target: LibraryDeleteTarget, trigger: HTMLElement) => void; canMutate?: boolean; mutationUnavailableReason?: string }) {
  return (
