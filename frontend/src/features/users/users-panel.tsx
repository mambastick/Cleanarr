  ...
  return <section className="space-y-5">
    ...
    <Card className="overflow-hidden p-4 sm:p-5">
      ...
      <CardContent className="mt-4 p-0">
        <div className="overflow-x-auto rounded-xl border border-border [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        {currentRole !== "admin" ? <p className="border-b bg-muted/40 px-4 py-2 text-xs text-muted-foreground">{text.adminOnly}</p> : null}
